...
| **11, last** | [Authentication & owner scoping](phases/phase-11-auth.md) | **In progress — 11.1a done 2026-09-04.** Started early at the user's instruction; the gate was about when auth becomes load-bearing, not a dependency. Split into 11.1a/b/c, 11.2, 11.3. 11.1a is the Identity module, the sixth schema and seven tables — nothing enforced yet |
