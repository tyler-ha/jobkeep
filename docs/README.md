...
| 2.2 | [Query, filter, sort & page the list](phases/phase-2.2-list-queries.md) | Not started |
| 2.3 | [Analytics endpoints](phases/phase-2.3-analytics.md) | Not started |
| 2.4 | [Enforce the status lifecycle](phases/phase-2.4-status-rules.md) | Not started |
| 2.5 | [Upgrade to .NET 10 (LTS)](phases/phase-2.5-dotnet10-upgrade.md) | Not started |
